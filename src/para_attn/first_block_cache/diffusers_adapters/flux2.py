...
class ModuleWithCache(torch.nn.Module):
...
def apply_cache_on_transformer(
    ...
    cached_transformer_blocks = torch.nn.ModuleList(
        [
            utils.CachedTransformerBlocksFlux2(
    ...
    transformer.single_stream_modulation = ModuleWithCache(transformer.single_stream_modulation)
